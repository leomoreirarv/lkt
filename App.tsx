...
import { ThemeProvider, Header, ListItem } from 'react-native-elements';
...
export class CardList extends Component<any> {
  state;
  constructor(props) {
    super(props)
    this.state = {
...
export function loadCards() {
  return fetch("https://api.magicthegathering.io/v1/cards?page=0&pageSize=5&contains=imageUrl")
